  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use TodoItem.user() instead.
        "::get::TodoItem::user": {
          url: urlBase + "/TodoItems/:id/user",
          method: "GET"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `TodoItem` object.)
         * </em>
         */
        "create": {
        ...
        /**
         * @ngdoc method
         * @name lbServices.TodoItem#createMany
         * @methodOf lbServices.TodoItem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.TodoItem#updateAll
         * @methodOf lbServices.TodoItem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.TodoItem#createChangeStream
         * @methodOf lbServices.TodoItem
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/TodoItems/change-stream",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.TodoItem#check
         * @methodOf lbServices.TodoItem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.TodoItem#update
         * @methodOf lbServices.TodoItem
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.TodoItem#modelName
    * @propertyOf lbServices.TodoItem
    * @description
    * The name of the model represented by this $resource,
    * i.e. `TodoItem`.
    */
    R.modelName = "TodoItem";


        /**
         * @ngdoc method
         * @name lbServices.TodoItem#user
         * @methodOf lbServices.TodoItem
         *
         * @description
         *
        ...
        R.user = function() {
          ...
          var action = TargetResource["::get::TodoItem::user"];
